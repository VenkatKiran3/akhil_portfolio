...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="relative overflow-hidden" style={{ background: "#000000", padding: "5rem 0" }}>
      {/* Background */}
      ...
      {[
        ...
        <motion.div key={i} className="absolute rounded-full pointer-events-none" style={{ width: 3, height: 3, left: p.left, top: p.top, background: "rgba(255,255,255,0.1)" }} animate={{ y: [0, -25, 0], opacity: [0.1, 0.4, 0.1] }} transition={{ duration: p.dur, delay: p.delay, repeat: Infinity, ease: "easeInOut" }} />
      ))}
      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-8 lg:px-16 relative z-10">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={vp} transition={{ duration: 0.6 }} className="mb-12 sm:mb-20">
          ...
          <motion.p initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={vp} transition={{ delay: 0.4, duration: 0.5 }}
            className="text-base sm:text-lg mt-6"
            style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 400, color: "#bbbbbb", maxWidth: "480px", lineHeight: 1.8 }}
          >
          ...
          >
            ...
            <span className="text-xs sm:text-sm" style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 500, color: "#ffffff", letterSpacing: "0.2em", textTransform: "uppercase" }}>Available for hire</span>
          </motion.div>
        </motion.div>
        ...
        <div className="grid gap-12 sm:gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          >
            {[
              ...
              <motion.div key={field.name} initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={vp} transition={{ delay: 0.3 + fi * 0.1 }}>
                <label className="text-xs sm:text-[11px]" style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 500, color: focusedField === field.name ? "#ffffff" : "#888888", letterSpacing: "0.3em", textTransform: "uppercase", display: "block", marginBottom: "12px", transition: "color 0.3s" }}>
                  {field.label}
                </label>
                <input
                  type={field.type}
                  ...
                  style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 400, color: "#ffffff", width: "100%", borderBottom: focusedField === field.name ? "1px solid #ffffff" : "1px solid rgba(255,255,255,0.15)", background: "transparent", padding: "14px 0", outline: "none", transition: "border-color 0.3s" }}
                />
              </motion.div>
            ))}
            <motion.div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={vp} transition={{ delay: 0.5 }}>
              <label className="text-xs sm:text-[11px]" style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 500, color: focusedField === "message" ? "#ffffff" : "#888888", letterSpacing: "0.3em", textTransform: "uppercase", display: "block", marginBottom: "12px", transition: "color 0.3s" }}>
                YOUR MESSAGE
              </label>
              <textarea
                required
                ...
                onBlur={() => setFocusedField(null)}
                className="text-base sm:text-lg"
                style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 400, color: "#ffffff", width: "100%", borderBottom: focusedField === "message" ? "1px solid #ffffff" : "1px solid rgba(255,255,255,0.15)", background: "transparent", padding: "14px 0", outline: "none", resize: "none", transition: "border-color 0.3s" }}
              />
            </motion.div>
            <motion.button
              type="submit"
              ...
              whileTap={{ scale: 0.97 }}
              className="group inline-flex items-center gap-3 transition-all duration-400 text-sm sm:text-[13px]"
              style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 500, color: "#ffffff", letterSpacing: "0.25em", textTransform: "uppercase", border: "1px solid rgba(255,255,255,0.3)", padding: "14px 36px", marginTop: "12px", cursor: "pointer", background: "transparent" }}
            >
              SEND MESSAGE
            ...
            {[
              ...
              >
                <motion.div
                  ...
                  className="flex h-12 w-12 sm:h-14 sm:w-14 shrink-0 items-center justify-center transition-all duration-300"
                  style={{ border: "1px solid rgba(255,255,255,0.15)" }}
                >
                  <i className={`${icon} text-white text-base sm:text-lg`} />
                </motion.div>
                <div>
                  <p className="text-[11px] sm:text-xs" style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 500, color: "#888888", letterSpacing: "0.3em", textTransform: "uppercase", marginBottom: "6px" }}>{label}</p>
                  <p className="text-sm sm:text-base" style={{ fontFamily: "'Montserrat', sans-serif", fontWeight: 400, color: "#ffffff", transition: "opacity 0.3s" }} >{value}</p>
                </div>
              </motion.a>
            ))}
          </motion.div>
