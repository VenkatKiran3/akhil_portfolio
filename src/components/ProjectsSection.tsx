    ...
    >
      ...
      >
        <div className="absolute inset-0 overflow-hidden" style={{ border: "1px solid rgba(255,255,255,0.08)" }}>
          ...
          <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex items-center justify-center">
            <motion.span
              ...
              style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "32px", color: "#ffffff", letterSpacing: "0.15em" }}
            >
              {project.title}
            </motion.span>
          </div>
        ...
        <motion.div
          ...
          className="absolute -top-2 -left-2 w-8 h-8 border-t border-l border-white/15"
        />
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          ...
          className="absolute -bottom-2 -right-2 w-8 h-8 border-b border-r border-white/15"
        />
      </motion.div>
      ...
      <div>
        ...
        >
          {project.tags.map((tag) => (
            <span
              key={tag}
              style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "11px", fontWeight: 500, color: "#aaaaaa", letterSpacing: "0.2em", border: "1px solid rgba(255,255,255,0.2)", padding: "5px 14px", textTransform: "uppercase" }}
            >
              {tag}
            </span>
          ))}
        ...
        <motion.h3
          ...
          style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "clamp(32px, 4vw, 48px)", color: "#ffffff", letterSpacing: "0.04em", marginBottom: "6px" }}
        >
          {project.title}
        </motion.h3>
        ...
        <motion.p
          ...
          style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "13px", fontWeight: 500, color: "#888888", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: "6px" }}
        >
        ...
        <motion.p
          ...
          style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "13px", fontWeight: 400, color: "#aaaaaa", marginBottom: "18px" }}
        >
          {project.subtitle}
        </motion.p>
        <motion.p
          ...
          style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "15px", fontWeight: 400, color: "#bbbbbb", lineHeight: 1.9, marginBottom: "24px" }}
        >
          {project.description}
        </motion.p>
        ...
        <ul className="mb-8 space-y-3">
          {project.highlights.map((point, j) => (
            <motion.li
              ...
              style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "14px", fontWeight: 400, color: "#bbbbbb", lineHeight: 1.7 }}
            >
              <span className="mt-2.5 block h-1 w-1 shrink-0 rounded-full" style={{ background: "#ffffff", opacity: 0.5 }} />
              {point}
            </motion.li>
          ))}
        </ul>
        ...
        <div className="flex flex-col gap-4">
          {project.links.map((link, li) => (
            <motion.a
              ...
              style={{ fontFamily: "'Montserrat', sans-serif", fontSize: "13px", fontWeight: 500, color: "#ffffff", letterSpacing: "0.15em", textTransform: "uppercase", textDecoration: "none" }}
            >
              {link.label}
...
const ProjectsSection = () => {
  return (
    <section id="projects" className="relative overflow-hidden" style={{ background: "#050505", padding: "8rem 0" }}>
      {/* Background animations */}
      <motion.div
        className="absolute pointer-events-none"
        style={{ width: "700px", height: "700px", border: "1px solid rgba(255,255,255,0.02)", borderRadius: "50%", bottom: "-20%", left: "-15%" }}
        animate={{ rotate: 360 }}
        transition={{ duration: 100, repeat: Infinity, ease: "linear" }}
      />
      <motion.div
        className="absolute pointer-events-none"
        style={{ width: "400px", height: "400px", border: "1px solid rgba(255,255,255,0.03)", borderRadius: "50%", top: "10%", right: "-8%" }}
        animate={{ rotate: -360 }}
      ...
      <motion.div
        className="absolute pointer-events-none"
        style={{ left: "50%", top: 0, bottom: 0, width: "1px", background: "rgba(255,255,255,0.03)" }}
        initial={{ scaleY: 0 }}
